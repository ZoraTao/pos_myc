  ...
  export default {
    ...
    methods: {
      ...
      getMemberCard(){
        var that = this;
        let _this = this;
        console.log(_this.modifyMessage)
          _this.addMemberForm.name = _this.modifyMessage.name;
          _this.addMemberForm.cardId = _this.modifyMessage.cardName;
          _this.addMemberForm.telphone = _this.modifyMessage.telphone;
          _this.addMemberForm.birthday = _this.modifyMessage.birthday;
          _this.addMemberForm.sex = _this.modifyMessage.sex;
          _this.addMemberForm.job = _this.modifyMessage.job;
        that.$axios({
